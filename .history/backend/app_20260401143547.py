...
import numpy as np
import librosa
import noisereduce as nr  # ✅ ADDED
...
# ✅ UPDATED extract_feature with noise reduction and normalization
...
def predict(data: ImageData):
    ...
    try:
        ...
        # ✅ Try FER first - handles ALL faces
        if fer_detector is not None:
            try:
                ...
                if result and len(result) > 0:
                    ...
                    for face in result:  # ✅ loop ALL faces
...
async def predict_audio(chunk: AudioChunk):
    ...
    print(f"✅ AUDIO: {emotion} ({confidence:.2%})")
