...
try:
    ...
    print("Model classes:", image_model.names)  # ✅ ADDED
...
def predict(data: ImageData):
    ...
    try:
        ...
        # ✅ ADDED - Convert to grayscale like training data
        gray = cv2.cvtColor(img, cv2.COLOR_RGB2GRAY)
        img = cv2.cvtColor(gray, cv2.COLOR_GRAY2RGB)

        results = image_model(img, verbose=False, conf=0.10)  # ✅ lowered to 0.10
